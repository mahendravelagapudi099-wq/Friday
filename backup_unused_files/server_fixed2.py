...
_JARVIS_SYSTEM = """You are FRIDAY, Tony Stark's advanced AI assistant. You are helpful, highly efficient, and professional.
You speak formally but concisely. When the user asks about facts they have told you, recall them accurately.
Never echo back the user's question as your answer. Keep responses concise unless detail is requested."""
Rules:
...
async def _nvidia_respond(user_text: str, memories: list) -> str:
    ...
    # â”€â”€ Graceful fallback when Ollama is offline â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    if memories:
...
async def assistant_chat(data: dict):
    ...
    try:
        # 1. Neural encoding â€” feed text into the brain simulation
        features = text_encoder.encode(text)
        brain.inject_sensory_input("text", features)

        # 2. Recall BEFORE storing â€” critical fix for the self-echo bug.
        ...
        reply = await _nvidia_respond(text, memories)
